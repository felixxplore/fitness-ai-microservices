...
// node_modules/react-oauth2-code-pkce/dist/useBrowserStorage.js
var require_useBrowserStorage = __commonJS({
  "node_modules/react-oauth2-code-pkce/dist/useBrowserStorage.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
// node_modules/react-oauth2-code-pkce/dist/useInterval.js
var require_useInterval = __commonJS({
  "node_modules/react-oauth2-code-pkce/dist/useInterval.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
var require_AuthContext = __commonJS({
  "node_modules/react-oauth2-code-pkce/dist/AuthContext.js"(exports) {
    ...
    var useBrowserStorage_1 = require_useBrowserStorage();
    var useInterval_1 = require_useInterval();
    ...
    var AuthProvider = ({ authConfig, children }) => {
      ...
      const [refreshToken, setRefreshToken] = (0, useBrowserStorage_1.useBrowserStorage)(`${config.storageKeyPrefix}refreshToken`, void 0, config.storage);
      const [refreshTokenExpire, setRefreshTokenExpire] = (0, useBrowserStorage_1.useBrowserStorage)(`${config.storageKeyPrefix}refreshTokenExpire`, void 0, config.storage);
      const [token, setToken] = (0, useBrowserStorage_1.useBrowserStorage)(`${config.storageKeyPrefix}token`, "", config.storage);
      const [tokenExpire, setTokenExpire] = (0, useBrowserStorage_1.useBrowserStorage)(`${config.storageKeyPrefix}tokenExpire`, (0, timeUtils_1.epochAtSecondsFromNow)(timeUtils_1.FALLBACK_EXPIRE_TIME), config.storage);
      const [idToken, setIdToken] = (0, useBrowserStorage_1.useBrowserStorage)(`${config.storageKeyPrefix}idToken`, void 0, config.storage);
      const [loginInProgress, setLoginInProgress] = (0, useBrowserStorage_1.useBrowserStorage)(`${config.storageKeyPrefix}loginInProgress`, false, config.storage);
      const [refreshInProgress, setRefreshInProgress] = (0, useBrowserStorage_1.useBrowserStorage)(`${config.storageKeyPrefix}refreshInProgress`, false, config.storage);
      const [loginMethod, setLoginMethod] = (0, useBrowserStorage_1.useBrowserStorage)(`${config.storageKeyPrefix}loginMethod`, "redirect", config.storage);
      ...
      function manualRefreshToken() {
        return __awaiter(this, void 0, void 0, function* () {
          ...
          return (0, authentication_1.fetchWithRefreshToken)({ config, refreshToken }).then((result) => handleTokenResponse(result)).finally(() => {
            setRefreshInProgress(false);
          });
        });
      }
      function internalRefreshAccessToken(initial = false) {
        if (!token)
          return;
      ...
      (0, useInterval_1.useInterval)(internalRefreshAccessToken, 1e4, 5e3);
...
Expected  to find a '?code=' parameter in the URL by now. Did the authentication get aborted or interrupted?`);
        ...
        if (!token && config.autoLogin)
          return logIn(void 0, void 0, config.loginMethod);
        internalRefreshAccessToken(true);
      }, []);
